...
- **Мобильная оптимизация**:
  - Адаптивные попапы с центрированием на мобильных устройствах
  - Отключение hover-подсказок на устройствах с шириной экрана < 1280px
  - Поддержка pinch-zoom и жестов для управления картой
